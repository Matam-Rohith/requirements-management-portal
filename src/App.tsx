          ...
          <div className='max-w-5xl mx-auto px-4 sm:px-6 py-6'>
            <AnimatePresence mode='wait'>
              <motion.div key={page}
                ...
                {page === 'dashboard'    && <DashboardPage    requirements={requirements} />}
                {page === 'requirements' && <RequirementsPage requirements={requirements} isAdmin={isAdmin} onUpdate={setRequirements} />}
                {page === 'analytics'   && <AnalyticsPage    requirements={requirements} />}
              </motion.div>
            </AnimatePresence>
          </div>
        </main>
