    ...
    <DialogContent className='max-w-md'>
      ...
      <form onSubmit={handleSubmit} className='space-y-3 mt-2'>
        ...
        <div>
          ...
          <textarea className={`${field} min-h-[80px] resize-none`} value={form.description} onChange={e => set('description', e.target.value)} required placeholder='Detailed description...' />
        </div>
        ...
        <div>
          ...
          <input className={field} value={form.tags} onChange={e => set('tags', e.target.value)} placeholder='auth, security, backend' />
        </div>
