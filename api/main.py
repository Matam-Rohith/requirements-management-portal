...
app = FastAPI(title="Requirements Management Portal API", version="1.0.0")
...
REQUIREMENTS: List[dict] = [
    ...
    {"id": "req-002", "title": "Requirements Dashboard", "description": "Build a real-time dashboard showing requirement stats, progress charts, and recent activity.", "priority": "High", "status": "In Progress", "assignee": "viewer", "created_by": "admin", "created_at": "2024-03-02T10:00:00", "updated_at": "2024-03-12T11:00:00", "tags": ["dashboard", "charts"]},
    ...
    {"id": "req-004", "title": "Email Notifications", "description": "Send email alerts when requirement status changes or new requirements are assigned.", "priority": "Low", "status": "Open", "assignee": "viewer", "created_by": "admin", "created_at": "2024-03-06T14:00:00", "updated_at": "2024-03-06T14:00:00", "tags": ["notifications", "email"]},
...
@app.delete("/api/requirements/{req_id}", status_code=204)
